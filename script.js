(() => {
  ...
  const JOBS_CAT_META = {
    ...
    "STATE_JOBS":           { id: "State Jobs",               title: "State Govt Jobs",        color: "linear-gradient(135deg,#9333ea,#a855f7)", icon: "fa-solid fa-map-location-dot" },
    "CENTRAL_JOBS":         { id: "Central Jobs",             title: "Central Govt Jobs",      color: "linear-gradient(135deg,#0f766e,#0d9488)", icon: "fa-solid fa-landmark" },
