(() => {
  ...
  // -------------------------
  // Desktop dropdowns  ✅ FIXED: no disappearing on hover
  // -------------------------
  function initDropdowns(){
    ...
    const scheduleClose = (dd, delay=140) => {
      const btn=$(".nav-dd-btn", dd);
      const menu=$(".nav-dd-menu", dd);
      if(!btn || !menu) return;
    ...
    dds.forEach(dd=>{
      ...
      // Click toggle for touch / non-hover devices
      ...
      // Hover behavior (desktop) - do NOT instantly close on mouseleave
